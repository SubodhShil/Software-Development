...
function Footer() {
    return (
        <div>
            <footer className="mt-auto bg-[#043071] w-full">
                        ...
                        <div>
                            ...
                            >
                                <svg
                                    ...
                                    viewBox="0 0 16 16"
                                >
                                    <path d="M8 0C3.58 0 0 3.58 0 8c0 3.54 2.29 6.53 5.47 7.59.4.07.55-.17.55-.38 0-.19-.01-.82-.01-1.49-2.01.37-2.53-.49-2.69-.94-.09-.23-.48-.94-.82-1.13-.28-.15-.68-.52-.01-.53.63-.01 1.08.58 1.23.82.72 1.21 1.87.86 2.32.66.07-.52.28-.87.52-1.07-1.79-.2-3.66-.9-3.66-4.01 0-.88.32-1.6.85-2.17-.09-.21-.37-.99.08-2.08 0 0 .68-.22 2.23.85a7.82 7.82 0 0 1 4.04 0c1.55-1.07 2.23-.85 2.23-.85.45 1.09.17 1.87.08 2.08.53.57.85 1.29.85 2.17 0 3.11-1.87 3.81-3.66 4.01.28.24.52.71.52 1.38 0 1-.01 1.83-.01 2.08 0 .21.15.45.55.38 3.18-1.06 5.47-4.06 5.47-7.59 0-4.42-3.58-8-8-8z" />
                                </svg>
                            </a>
                        </div>
                        {/* End Social Brands */}
